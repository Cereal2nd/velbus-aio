...
register_command(COMMAND_CODE, ChannelNamePart1Message2, "VMBGP4PIR-2")
...
register_command(COMMAND_CODE, ChannelNamePart1Message2, "VMBIN")
register_command(COMMAND_CODE, ChannelNamePart1Message2, "VMBKP")
register_command(COMMAND_CODE, ChannelNamePart1Message2, "VMBELPIR")
...
register_command(COMMAND_CODE, ChannelNamePart1Message2, "VMBDALI")
