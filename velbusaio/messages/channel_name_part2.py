...
register_command(COMMAND_CODE, ChannelNamePart2Message2, "VMBGP4PIR-2")
...
register_command(COMMAND_CODE, ChannelNamePart2Message2, "VMBIN")
register_command(COMMAND_CODE, ChannelNamePart2Message2, "VMBKP")
